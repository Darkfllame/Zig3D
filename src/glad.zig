        ...
        switch (tinfo) {
            inline .Struct => {
                switch (T) {
                    ...
                    Mat2f => c.glUniformMatrix2fv(@intCast(location), 1, @intFromBool(false), value.cols),
                    Mat2d => c.glUniformMatrix2dv(@intCast(location), 1, @intFromBool(false), value.cols),
                    Mat3f => c.glUniformMatrix3fv(@intCast(location), 1, @intFromBool(false), value.cols),
                    Mat3d => c.glUniformMatrix3dv(@intCast(location), 1, @intFromBool(false), value.cols),
                    Mat4f => c.glUniformMatrix4fv(@intCast(location), 1, @intFromBool(false), value.cols),
                    Mat4d => c.glUniformMatrix4dv(@intCast(location), 1, @intFromBool(false), value.cols),
